...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3e733a410857832a9d3ab277092fbda4) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.cmd_main =
              [
                 (OASISExpr.EBool true,
                   ("sh", ["-c"; "\"omake"; "PREFIX=$prefix\""]))
              ];
            cmd_clean =
              [
                 (OASISExpr.EBool true,
                   Some
                     (("sh", ["-c"; "\"omake"; "PREFIX=$prefix"; "clean\""])))
              ];
       ...
       CustomPlugin.main
         {
            CustomPlugin.cmd_main =
              [
                 (OASISExpr.EBool true,
                   ("sh", ["-c"; "\"omake"; "PREFIX=$prefix"; "install\""]))
              ];
       ...
       CustomPlugin.main
         {
            CustomPlugin.cmd_main =
              [
                 (OASISExpr.EBool true,
                   ("sh", ["-c"; "\"omake"; "PREFIX=$prefix"; "uninstall\""]))
              ];
            cmd_clean = [(OASISExpr.EBool true, None)];
            cmd_distclean = [(OASISExpr.EBool true, None)]
         };
          ...
          CustomPlugin.clean
            {
               CustomPlugin.cmd_main =
                 [
                    (OASISExpr.EBool true,
                      ("sh",
                        ["-c"; "\"omake"; "PREFIX=$prefix"; "uninstall\""]))
                 ];
               cmd_clean = [(OASISExpr.EBool true, None)];
               cmd_distclean = [(OASISExpr.EBool true, None)]
            }
     ...
     package =
       {
          ...
          authors = ["derui"];
          homepage = None;
          synopsis = "Type constrainted algebra library";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\249EZs\179;O\172\\]y\249\185\162\159V";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
