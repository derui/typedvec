...
(** The type of detect the point for between two line. *)
...
(* [nearest_point ~a ~b ()] get the nearest points between [a] and [b].
   If [a] and [b] is parallel, can not return any point, so return [Parallel].
*)
