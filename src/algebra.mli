...
(** [cross_to_mat vec] get the matrix to cross product any vector. Notion using matrix returned from this function only
    allows to apply [mat *< vec] only. [Vec.cross a b] equality [(cross_to_mat a) *< b]. *)
